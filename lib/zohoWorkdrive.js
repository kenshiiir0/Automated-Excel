...
// Lists the immediate contents (files + subfolders) of the connected HR
// Documents folder. WorkDrive's API is JSON:API-shaped -- data is an array
// of { id, attributes: { name, type, ... } } objects.
