...
//
// Ordered fastest-first (not "most capable first"): 'gemini-2.0-flash' is
// consistently quicker for a short single-paragraph task like this than
// '2.5-flash', which is a heavier model tuned for more complex reasoning
// this task doesn't need. 'gemini-flash-latest' is the last-resort
// always-current alias in case both explicit versions above go away.
